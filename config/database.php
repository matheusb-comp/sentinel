...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Selected by phpunit.xml. The database is hardcoded because the
        // container defines DB_DATABASE as a real environment variable, which
        // phpunit.xml cannot override.
        'sqlite_testing' => [
            'driver' => 'sqlite',
            'database' => ':memory:',
            'prefix' => '',
